...
if (move_uploaded_file($_FILES['arquivo']['tmp_name'], $_UP['pasta'] . $nome_final)) {
 ...
 $cadastro = mysql_query("INSERT INTO produtos (codigo, produto, descricao, estoque, codigo_original, codigo_paralelo, ncm, preco, promocao, custo, ultimo_fornecedor, foto) VALUES ('$codigo', '$produto', '$descricao', '$estoque', '$codigo_original', '$codigo_paralelo', '$ncm', '$preco', '$promocao', '$custo', '$ultimo_fornecedor', '$nome_final')");
