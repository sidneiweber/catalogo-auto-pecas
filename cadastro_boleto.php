...
?>
  ...
  <div class="form-group">
    ...
    <input type="text" required value="" onkeypress="return number(event);" name="numero_documento" title="Preencha com o numero documento."  class="form-control input-sm" id="numero_documento" placeholder="Numero do documento">
  </div>
  <div class="form-group">
    <label for="data">Data</label>
    <input type="text" required value="" name="data" onkeypress="return number(event), mascara(this, '##/##/####');"title="Preencha com a data."  class="form-control input-sm" id="data" placeholder="Dia do vencimento" maxlength=10>
  </div>
  <div class="form-group">
    <label for="valor">valor</label>
    <input type="text" required value=""  onkeypress="return number(event);" name="valor" title="Preencha com o valor."  class="form-control input-sm" id="valor" placeholder="Valor do boleto">
  </div>
  <div class="form-group">
