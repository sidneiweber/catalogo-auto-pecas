	...
	class shopping{	
			...
			if($_SESSION){
				foreach($_SESSION['produto'] as $id => $campo ){
					if($campo['id'] > 0){
						$id = $campo['id'];
						// MONTAR CARRINHO
						$PD = mysql_query("SELECT id, codigo, produto, descricao, preco FROM produtos WHERE id=".mysql_real_escape_string((int)$id));
						while($list = mysql_fetch_assoc($PD)){
							...
							<th width="7%" height="44" align="center" valign="middle" bgcolor="#FFFFFF">'.$campo['quantidade'].' X </th>							
							<th width="11%" height="44" align="center" valign="middle" bgcolor="#FFFFFF">R$ '.number_format($campo['preco'], 2).'</th>							
							...
							<th width="11%" height="44" align="center" valign="middle" bgcolor="#FFFFFF"> R$ '.number_format($subTotal, 2).'</th>						</tr>							
							<br>';
				...
				if($Total == 0){	
					...
					<th align="center" valign="middle" bgcolor="#FFFFFF" height="44">R$ '.number_format($Total, 2).'	
					</tr>	
					<tr>	
					<td colspan="6"></td>	
					<td align="center" valign="middle" bgcolor="#FFFFFF" height="44">	
					<a href="index.php">	
					<img src="images/home.png" align="left" border="0">Adicionar mais produtos	
					</a>	
					</td>	
					</tr>';
				}
		...
		function clientes(){
			if($_SESSION){
				...
				$campoSelect = "<select name = 'cliente'>";
